...
<body>
    <div class="pos-header">
        ...
        <div class="header-right">
            ...
            <a href="<?php echo e(url('/admin')); ?>"><i class="fas fa-th-large"></i> Dashboard</a>
        </div>
    </div>
    ...
    <div class="pos-body">
        ...
        <div class="pos-products">
            ...
            <div id="product-grid" class="product-grid">
                <?php echo $__env->make('admin.pos._products', ['products' => $products], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
        </div>
        ...
        <div class="pos-cart">
            <div class="pos-cart-header">
                <h2><i class="fas fa-shopping-cart"></i> Pesanan <span id="cart-count"><?php echo e(count($posCart)); ?></span></h2>
                <button onclick="clearCart()" id="clear-cart-btn" <?php echo e(empty($posCart) ? 'style=display:none' : ''); ?>><i class="fas fa-trash-alt"></i> Hapus Semua</button>
            </div>
            <div id="pos-cart-items" class="pos-cart-items">
                <?php echo $__env->make('admin.pos._cart', ['posCart' => $posCart], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            </div>
            <div class="pos-cart-footer">
                <form id="checkout-form" method="POST" action="<?php echo e(route('admin.pos.checkout')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="total-row">
                        <span>Total</span>
                        <span class="total-amount" id="cart-total">Rp <?php echo e(number_format($cartTotal, 0, ',', '.')); ?></span>
                    </div>
                    ...
                    <div id="bank-options" class="bank-options">
                        <select name="bank_account_id">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::openLoop(); ?><?php endif; ?><?php $__currentLoopData = $bankAccounts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bank): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
                                <option value="<?php echo e($bank->id); ?>"><?php echo e($bank->bank_name); ?> - <?php echo e($bank->account_number); ?></option>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
                        </select>
                    </div>
    ...
    <script>
    <?php if($errors->any()): ?>
        var errorMessages = <?php echo json_encode($errors->all(), 15, 512) ?>;
    ...
    <?php if(session('error')): ?>
        window.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() { notify('<?php echo e(session('error')); ?>', 'error'); }, 200);
        });
    <?php endif; ?>

    <?php if(session('success')): ?>
        window.addEventListener('DOMContentLoaded', function() {
            setTimeout(function() { notify('<?php echo e(session('success')); ?>', 'success'); }, 200);
        });
    <?php endif; ?>
    </script>
    ...
    <script>
        ...
        function clearCart() {
            ...
            toggleCheckout();
            fetch('<?php echo e(route('admin.pos.remove')); ?>', {
                method: 'POST',
        ...
        function addProduct(productId, name) {
            fetch('<?php echo e(route('admin.pos.add')); ?>', {
                method: 'POST',
                headers: {'Content-Type': 'application/json', 'X-CSRF-TOKEN': csrf},
        ...
        function updateQty(productId, delta) {
            ...
            fetch('<?php echo e(route('admin.pos.update')); ?>', {
                method: 'POST',
                headers: {'Content-Type': 'application/json', 'X-CSRF-TOKEN': csrf},
        ...
        function loadProducts(page = 1) {
            ...
            const url = '<?php echo e(route('admin.pos.search')); ?>?q=' + encodeURIComponent(q) + '&category_id=' + cat + '&page=' + page;
            fetch(url)
                .then(r => r.json())
                .then(d => {
...
</html><?php /**PATH C:\Users\pro021\procell-store\resources\views/admin/pos/index.blade.php ENDPATH**/ ?>