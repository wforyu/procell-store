                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="guest_name" id="guest_name" value="<?php echo e(old('guest_name')); ?>" required class="input-field" placeholder="Nama lengkap Anda">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="email" name="guest_email" id="guest_email" value="<?php echo e(old('guest_email')); ?>" required class="input-field" placeholder="email@contoh.com">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="text" name="guest_phone" id="guest_phone" value="<?php echo e(old('guest_phone')); ?>" required class="input-field" placeholder="0812xxxx">
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="number" name="destination_city" id="destination_city" min="1"
                                   ...
                                   value="<?php echo e(old('destination_city')); ?>">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['destination_city'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> <p class="text-red-500 text-xs mt-1"><?php echo e($message); ?></p> <?php unset($message);
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="shipping_address" id="shipping_address" rows="3" required class="input-field"><?php echo e(old('shipping_address', auth()->check() ? auth()->user()->address : '')); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="bg-white rounded-2xl border border-gray-100 p-6">
                    ...
                    <div class="space-y-4" x-data="{
                        courier: '<?php echo e(old('courier')); ?>',
                        service: '<?php echo e(old('courier_service')); ?>',
                        loading: false,
                        courierRates: {}
                    }">
            ...
            <div class="lg:col-span-1">
                 <div class="bg-white rounded-2xl border border-gray-100 p-6 sticky top-28"
                      x-data="{
                          ...
                          couponMessage: '',
                          loadingRates: false,
                          rajaOngkirConfigured: <?php echo e($rajaOngkirConfigured ? 'true' : 'false'); ?>,
                          totalWeight: <?php echo e($totalWeight); ?>,
                          pointsToUse: <?php echo e(old('points_to_use', 0)); ?>,
                          <?php if(!$isGuest): ?>
                          pointsRate: <?php echo e($loyalty->getRedeemRate()); ?>,
                          get pointsDiscount() {
                              return Math.min(this.pointsToUse * this.pointsRate, this.subtotal * 0.5);
                          },
                          useMaxPoints() {
                              this.pointsToUse = <?php echo e($maxRedeemPoints); ?>;
                          },
                          <?php else: ?>
                          pointsRate: 0,
                          ...
                          useMaxPoints() {},
                          <?php endif; ?>
                          courierRates: <?php echo e(json_encode(collect($couriers)->mapWithKeys(fn($c, $k) => [$k => ['name' => $c['name'], 'services' => collect($c['services'])->map(fn($cost, $svc) => ['cost' => $cost, 'service' => $svc, 'etd' => '-'])->keyBy('service')]]) )); ?>,
                          get shipping() {
                         ...
                         fetchRates() {
                             ...
                             fetch('<?php echo e(route('checkout.courier-rates')); ?>?destination=' + cityId + '&weight=' + weight)
                                 .then(r => r.json())
                                 .then(d => {
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="border-t border-gray-100 pt-3 mt-3">
                         ...
                         <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($pointsBalance > 0): ?>
                         <div class="border-t border-gray-100 pt-3 mt-3">
                             <div class="flex items-center justify-between mb-2">
                                 <span class="text-sm font-medium text-gray-700"><i class="fas fa-coins text-amber-500 mr-1"></i> Poin Saya</span>
                                 <span class="text-sm font-bold text-amber-600"><?php echo e(number_format($pointsBalance, 0, ',', '.')); ?> poin</span>
                             </div>
                             <p class="text-xs text-gray-400 mb-2">1 poin = Rp <?php echo e(number_format($loyalty->getRedeemRate(), 0, ',', '.')); ?> (maks 50% total)</p>
                             <div class="flex gap-2">
                                 <input type="number" name="points_to_use" x-model="pointsToUse" min="0" max="<?php echo e($maxRedeemPoints); ?>"
                                        class="flex-1 border border-gray-200 rounded-lg px-3 py-2 text-sm focus:border-amber-500 focus:ring-amber-500"
                                        placeholder="0">
                                 <button @click="useMaxPoints()" type="button" class="text-xs text-amber-600 hover:text-amber-700 font-medium px-2">Max</button>
                             </div>
                             <p class="text-xs text-gray-400 mt-1">Minimal <?php echo e(number_format($loyalty->getMinRedeem(), 0, ',', '.')); ?> poin</p>
                         </div>
                         <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                     </div>
