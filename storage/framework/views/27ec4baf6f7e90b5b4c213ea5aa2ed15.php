...
<urlset xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
    ...
    <url>
        <loc><?php echo e(route('products.category', $cat->slug)); ?></loc>
    ...
    <url>
        <loc><?php echo e(route('products.show', $product->slug)); ?></loc>
        <lastmod><?php echo e($product->updated_at ? $product->updated_at->tz('UTC')->toW3cString() : now()->toW3cString()); ?></lastmod>
    ...
    <url>
        ...
        <lastmod><?php echo e($page->updated_at ? $page->updated_at->tz('UTC')->toW3cString() : now()->toW3cString()); ?></lastmod>
        <priority>0.5</priority>
        <changefreq>monthly</changefreq>
    </url>
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::endLoop(); ?><?php endif; ?><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::closeLoop(); ?><?php endif; ?>
</urlset>
<?php /**PATH C:\Users\pro021\procell-store\resources\views\store\sitemap.blade.php ENDPATH**/ ?>