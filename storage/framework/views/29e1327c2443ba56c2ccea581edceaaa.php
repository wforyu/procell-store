...
<?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::processComponentKey($component); ?>
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-gray-500 mt-1">Terima kasih telah mendaftar! Verifikasi email Anda untuk memulai.</p>
    </div>

    <div class="p-4 bg-blue-50 border border-blue-100 rounded-xl text-sm text-blue-700 mb-6">
        <div class="flex items-start gap-2">
            ...
            <span>Sebelum memulai, bisa verifikasi email Anda dengan klik tautan yang sudah kami kirim. Jika tidak menerima email, kami akan kirim ulang.</span>
        </div>
    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(session('status') == 'verification-link-sent'): ?>
        <div class="flex items-center gap-2 p-3 bg-green-50 border border-green-200 rounded-xl text-sm font-medium text-green-700 mb-4">
...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('logout')); ?>">
            <?php echo csrf_field(); ?>
            <button type="submit" class="w-full inline-flex items-center justify-center px-6 py-3 border-2 border-gray-200 rounded-xl font-semibold text-sm text-gray-600 hover:border-gray-300 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-gray-300 focus:ring-offset-2 transition-all duration-200">
...
<?php endif; ?>
<?php /**PATH C:\Users\pro021\procell-store\resources\views/auth/verify-email.blade.php ENDPATH**/ ?>